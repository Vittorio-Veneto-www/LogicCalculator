...
# Form implementation generated from reading ui file 'd:\vscode\Python\LogicCalculator\./gui.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tab1.setAccessibleDescription("")
        self.tab1.setObjectName("tab1")
        self.display1 = QtWidgets.QTableView(self.tab1)
        self.display1.setGeometry(QtCore.QRect(0, 0, 501, 311))
        self.display1.setObjectName("display1")
        self.tabWidget.addTab(self.tab1, "")
        self.tab2 = QtWidgets.QWidget()
        self.tab2.setObjectName("tab2")
        self.display2 = QtWidgets.QTextBrowser(self.tab2)
        self.display2.setGeometry(QtCore.QRect(0, 0, 501, 311))
        self.display2.setObjectName("display2")
        self.tabWidget.addTab(self.tab2, "")
        self.tab3 = QtWidgets.QWidget()
        self.tab3.setObjectName("tab3")
        self.display3 = QtWidgets.QTextBrowser(self.tab3)
        self.display3.setGeometry(QtCore.QRect(0, 0, 501, 311))
        self.display3.setObjectName("display3")
        self.tabWidget.addTab(self.tab3, "")
        self.tab4 = QtWidgets.QWidget()
        self.tab4.setObjectName("tab4")
        self.display4 = QtWidgets.QListView(self.tab4)
        self.display4.setGeometry(QtCore.QRect(0, 0, 501, 311))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab1), _translate("MainWindow", "真值表"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab2), _translate("MainWindow", "主析取范式"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab3), _translate("MainWindow", "主合取范式"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab4), _translate("MainWindow", "化简"))
